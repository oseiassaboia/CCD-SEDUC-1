...
Public Class SituacaoCarta
	...
	Public Sub New(Optional ByVal SituacaoId as String = "")
		If SituacaoId <>"" Then
			Obter(SituacaoId)
		End If
	End Sub
	...
	Public Sub Salvar()
		...
		strSQL.Append(" where RH55_ID_SITUACAO_CARTA = " & SituacaoId)
	...
	Public Function Pesquisar(Optional ByVal Sort as String = "", Optional SituacaoId as Integer = 0, Optional Descricao as String = "") as DataTable
		Dim cnn As New Conexao
		Dim strSQL As New StringBuilder
		...
		If SituacaoId > 0 then 
			strSQL.Append(" and RH55_ID_SITUACAO_CARTA = " & SituacaoId)
		End If
		
		If Descricao <> "" then 
			strSQL.Append(" and upper(RH55_NM_SITUACAO_CARTA) like '%" & Descricao.toUpper & "%'")
		End If
