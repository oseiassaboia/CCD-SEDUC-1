...
Public Class Validacao
    ...
    Public Shared Sub Outros(ByVal Controle As TextBox, ByVal Requerido As Boolean, ByVal TituloCampo As String, Optional ByVal GrupoValidacao As String = "validacao", Optional ByVal Formato As eFormato = Nothing)
        ...
        With objMaskedEditExtender
            ...
            Select Case Formato
                ...
                Case eFormato.MATRICULA
                    .Mask = "99999999-99"
                    strValidacoes += String.Format("if (document.getElementById('{0}').value=='________-__') document.getElementById('{0}').value='';", Controle.ClientID)
    ...
    Public Shared Sub Finalizar(ByVal Botao As LinkButton, Optional ByVal GrupoValidacao As String = "validacao", Optional ByVal ExibirConfirmacao As Boolean = False, Optional ByVal Mensagem As String = "Deseja Salvar as Informações?")
        Dim objValidationSummary As New ValidationSummary
        ...
        If ExibirConfirmacao Then
            strValidacoes = "if (!confirm('" & Mensagem & "')) { return(false); } else { " & strValidacoes & " } "
        End If
    ...
    Public Shared Sub Finalizar(ByVal Botao As Button, Optional ByVal ExibirConfirmacao As Boolean = False, Optional ByVal strValicaoPersonalizada As String = "", Optional ByVal _Mensagem As String = "")
        Dim objValidationSummary As New ValidationSummary
        Dim GrupoValidacao As String = ""
        ...
        If ExibirConfirmacao Then
            ...
            If _Mensagem = "" Then
                _Mensagem = "Deseja Salvar as Informações?"
            End If

            If strValidacoes = "" Then
                strValidacoes = "if (!confirm('" & _Mensagem & "')) { return(false); } else { " & strValicaoPersonalizada & "; return(true); } "
            Else
                strValidacoes = "if (!confirm('" & _Mensagem & "')) { return(false); } else { " & strValidacoes & " } "
            End If
