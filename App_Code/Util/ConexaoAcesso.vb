...
Public Class ConexaoAcesso
    Private strStringConexao As String = System.Configuration.ConfigurationManager.ConnectionStrings("StringConexaoAcesso").ToString
    ...
    Public Function AbrirDataTable(ByVal SQL As String) As DataTable
        ...
        'Editado por Igor Antony em 20/01/2012 15:01:58
        If SQL.IndexOf("--") > 0 Or SQL.IndexOf("drop") > 0 Then
            Return Nothing
            Exit Function
        End If
