...
Public Class CrystalReport
    ...
    Public Shared Function Gerar(NomeRelatorio As String, Filtro As String,
                                Optional Parametros As List(Of ParametroRelatorio) = Nothing,
                                Optional cnn As Object = Nothing,
                                Optional path As String = Nothing,
                                Optional P_PaperSize As CrystalDecisions.Shared.PaperSize = 9) As String
        ...
        ElseIf Pagina.Session("FormatoRelatorio") = "data-xls" Then
            strArquivoDestino = "Temp/" & Pagina.Session.SessionID & Now.ToString("ddMMyyyyhhmmss") & ".xls"
        ...
        Else
            crReportDocument.Load(Pagina.Server.MapPath(path & NomeRelatorio))
        End If
        ...
        'PaperA3 '297 x 420 mm	11,7 x 16,5 pol
        'PaperLegal '216 x 356 mm	8,5 x 14,0 pol
        'Definir o tamanho do papel. O padrão é "A4" -> CrystalDecisions.Shared.PaperSize.PaperA4 = 9
        crReportDocument.PrintOptions.PaperSize = P_PaperSize
        ...
        With crReportDocument.ExportOptions
            ...
            ElseIf Pagina.Session("FormatoRelatorio") = "data-xls" Then
                .ExportFormatType = CrystalDecisions.Shared.ExportFormatType.ExcelRecord
            ElseIf Pagina.Session("FormatoRelatorio") = "doc" Then
